...
public interface Rados extends Library {
    ...
    int rados_write(Pointer ioctx, String oid, ByteBuffer buf, int len, long off);
    int rados_write_full(Pointer ioctx, String oid, byte[] buf, int len);
    int rados_write_full(Pointer ioctx, String oid, ByteBuffer buf, int len);
    int rados_append(Pointer ioctx, String oid, byte[] buf, int len);
    int rados_append(Pointer ioctx, String oid, ByteBuffer buf, int len);
    int rados_read(Pointer ioctx, String oid, byte[] buf, int len, long off);
    int rados_read(Pointer ioctx, String oid, ByteBuffer buf, int len, long off);
